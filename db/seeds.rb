...
10.times do
  User.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, description: Faker::ChuckNorris.fact, age: (15..75).to_a.sample, email: Faker::Internet.unique.email(domain: 'gmail'), city: City.all.sample, password: Faker::Food.fruits )
end
20.times do
...
5.times do
  PrivateMessage.create(sender: User.all.sample, content: Faker::TvShows::HeyArnold.quote)
  rand(1..6).times do
